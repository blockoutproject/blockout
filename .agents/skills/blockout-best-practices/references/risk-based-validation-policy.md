...
The repository's complete release profile is independent of task-risk selection. When that profile is required, run it
unchanged unless the current release owner explicitly authorizes a documented waiver.

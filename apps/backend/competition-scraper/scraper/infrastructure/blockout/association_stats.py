...
@dataclass
class UpdateAssociationStatsInternalRequest:
    """Exact request accepted by competition-service's stats route."""
    ...
    def add(
        ...
        """Accumulate one match contribution into the pending ranking totals."""
        self.played += played
        self.wins += wins
        self.losses += losses
        self.points += points

package com.blockout.clubs.shared.api.v2;
...
@Component
public class ClubsProblemFactory {

    private static final int MAX_REQUEST_ID_LENGTH = 255;
    private static final Logger LOGGER = LoggerFactory.getLogger(ClubsProblemFactory.class);
    public static final String REQUEST_ID_HEADER = "X-Request-Id";
    public static final String REQUEST_ID_ATTRIBUTE = ClubsProblemFactory.class.getName() + ".requestId";
    ...
    public ResponseEntity<ProblemDetail> response(
        ...
        ProblemDetail problem = new ProblemDetail(status.getReasonPhrase(), status.value(), code)
                ...
                .requestId(requestId);
        LOGGER.info("Clubs v2 problem", keyValue("problemCode", code), keyValue("status", status.value()),

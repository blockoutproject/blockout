...
public class CompetitionSecurityProblemWriter implements AuthenticationEntryPoint, AccessDeniedHandler {

    private static final String V2_PATH = "/api/v2/competitions";

...
@Component
public class LegalDocumentProblemFactory {

    private static final int MAX_REQUEST_ID_LENGTH = 255;
    private static final Logger LOGGER = LoggerFactory.getLogger(LegalDocumentProblemFactory.class);
    public static final String REQUEST_ID_HEADER = "X-Request-Id";
    public static final String REQUEST_ID_ATTRIBUTE = LegalDocumentProblemFactory.class.getName() + ".requestId";

...
public class ConfigSecurityProblemWriter implements AuthenticationEntryPoint, AccessDeniedHandler {

    private static final String V2_CONFIG_PATH = "/api/v2/config/";
    ...
    private boolean isV2(HttpServletRequest request) {
        return request.getRequestURI().startsWith(V2_CONFIG_PATH);
    }

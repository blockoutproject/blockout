...
@Component
public class PoolsProblemFactory {

    private static final int MAX_REQUEST_ID_LENGTH = 255;
    private static final Logger LOGGER = LoggerFactory.getLogger(PoolsProblemFactory.class);
    public static final String REQUEST_ID_HEADER = "X-Request-Id";
    public static final String REQUEST_ID_ATTRIBUTE = PoolsProblemFactory.class.getName() + ".requestId";
    ...
    public ResponseEntity<ProblemDetail> response(
        ...
        ProblemDetail problem = new ProblemDetail(status.getReasonPhrase(), status.value(), code)
                ...
                .requestId(requestId);
        LOGGER.info("Pools v2 problem", keyValue("problemCode", code), keyValue("status", status.value()),

...
public class RabbitMQConfig {
  ...
  public Binding bindPoolDeactivationQueuePools(
      TopicExchange entityLifecycleExchange, Queue poolDeactivationQueuePools) {
  ...
  public Binding bindUserFollowQueuePools(
    ...
    return BindingBuilder.bind(userFollowQueuePools).to(userFollowExchange).with("pool.follow");
  }

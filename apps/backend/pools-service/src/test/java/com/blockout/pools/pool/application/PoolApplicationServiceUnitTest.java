...
import com.blockout.pools.pool.application.commands.*;
...
@ExtendWith(MockitoExtension.class) @DisplayName("Pool application service")
class PoolApplicationServiceUnitTest {
    @Mock PoolRepository repository;
    @Mock PoolEventPublisher publisher;
    ...
    @Test @DisplayName("creates defaults and publishes the Pool search projection")
    ...
    @Test @DisplayName("updates mutable fields and clamps follower decrements")

...
import com.blockout.notifications.notification.infrastructure.persistence.entities.NotificationSendEntity;
...
@Repository
public interface NotificationSendRepository extends JpaRepository<NotificationSendEntity, Long> {
    ...
    @Query("""
            UPDATE NotificationSendEntity ns

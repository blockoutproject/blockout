...
public class UserNotificationApplicationService {
  ...
  private static final Logger logger =
      LoggerFactory.getLogger(UserNotificationApplicationService.class);
  ...
  public void createNotificationsBatch(List<UserNotificationEntity> items) {
    ...
    logger.info(
        "Notification inbox batch created",
  ...
  public NotificationPageView getNotifications(int page, int size) {
    ...
    Slice<UserNotificationEntity> slice =
    ...
    logger.debug(
        "Returning paginated notifications",
    ...
    return new NotificationPageView(
        slice.getContent().stream().map(this::toView).toList(), hasNext, nextPage);
  }

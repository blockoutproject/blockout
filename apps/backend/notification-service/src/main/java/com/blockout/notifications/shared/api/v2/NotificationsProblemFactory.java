...
/** Creates canonical notification-service Problem Details with stable request identifiers. */
@Component
public class NotificationsProblemFactory {

    public static final String REQUEST_ID_HEADER = "X-Request-Id";
    public static final String REQUEST_ID_ATTRIBUTE = NotificationsProblemFactory.class.getName() + ".requestId";
    private static final int MAX_REQUEST_ID_LENGTH = 255;
    private static final Logger LOGGER = LoggerFactory.getLogger(NotificationsProblemFactory.class);
    ...
    public ResponseEntity<ProblemDetail> response(
        ...
        ProblemDetail problem = new ProblemDetail(status.getReasonPhrase(), status.value(), code)
                ...
                .requestId(requestId);
        LOGGER.info("Notifications v2 problem",

...
public record UserProfileImageChange(ImageChangeModeEnum mode, UserProfileImageUpload upload) {
    ...
    public static UserProfileImageChange keep() {
        return new UserProfileImageChange(ImageChangeModeEnum.KEEP, null);
    }

    /** Creates an intent that removes the stored picture. */
    public static UserProfileImageChange remove() {
        return new UserProfileImageChange(ImageChangeModeEnum.REMOVE, null);
    }
    ...
    public static UserProfileImageChange replace(UserProfileImageUpload upload) {
        return new UserProfileImageChange(ImageChangeModeEnum.REPLACE, upload);
    }
}

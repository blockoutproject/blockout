...
public class ConfigInternalClient {
  ...
  public AppStatusView getAppStatus() {
    ...
    AppStatusInternalResponse body =
        internalApiClient.get(url, AppStatusInternalResponse.class).getBody();
  ...
  public AppStatusView updateAppStatus(UpdateAppStatusCommand command) {
    ...
    AppStatusInternalResponse body =
        internalApiClient
            .put(url, contractMapper.toInternalRequest(command), AppStatusInternalResponse.class)
            .getBody();
    return body == null ? null : contractMapper.toResponse(body);
  }
  ...
  public List<DivisionView> listDivisions() {
    ...
    DivisionInternalResponse[] body =
        internalApiClient.get(url, DivisionInternalResponse[].class).getBody();
    return body == null
  ...
  public DivisionView createDivision(UpsertDivisionCommand command, MultipartFile image) {
    ...
    DivisionInternalResponse response =
        internalApiClient.postMultipart(url, body, DivisionInternalResponse.class).getBody();
    return response == null ? null : contractMapper.toResponse(response);
  }

  @Caching(
      put = {@CachePut(value = "divisionById", key = "#id")},
      evict = {@CacheEvict(value = "divisions")})
  public DivisionView updateDivision(Long id, UpsertDivisionCommand command, MultipartFile image) {
    ...
    DivisionInternalResponse response =
        internalApiClient.putMultipart(url, body, DivisionInternalResponse.class).getBody();
    return response == null ? null : contractMapper.toResponse(response);
  }

  @Caching(
      evict = {@CacheEvict(value = "divisionById", key = "#id"), @CacheEvict(value = "divisions")})
  ...
  public LegalDocumentView getLegalDocument(String type) {
    ...
    LegalDocumentInternalResponse body =
        internalApiClient.get(url, LegalDocumentInternalResponse.class).getBody();
    return body == null ? null : contractMapper.toResponse(body);
  }
  ...
  public LegalDocumentView updateLegalDocument(String type, UpdateLegalDocumentCommand command) {
    ...
    LegalDocumentInternalResponse body =
        internalApiClient
            .put(
                url, contractMapper.toInternalRequest(command), LegalDocumentInternalResponse.class)
            .getBody();
    return body == null ? null : contractMapper.toResponse(body);
  }
  ...
  public RawDivisionMappingView createRawDivisionMapping(CreateRawDivisionMappingCommand command) {
    ...
    RawDivisionMappingInternalResponse body =
        internalApiClient
            .post(
                url,
                contractMapper.toCreateRequest(command),
                RawDivisionMappingInternalResponse.class)
            .getBody();
    return body == null ? null : contractMapper.toResponse(body);
  }
  ...
  public List<RawDivisionMappingView> listRawDivisionMappings(String leagueCode, String season) {
    ...
    RawDivisionMappingInternalResponse[] body =
        internalApiClient.get(url, RawDivisionMappingInternalResponse[].class).getBody();
    return body == null
        ? Collections.emptyList()
        : Arrays.stream(body).map(contractMapper::toResponse).toList();
  }
  ...
  public RawDivisionMappingView updateRawDivisionMapping(
      Long id, UpdateRawDivisionMappingCommand command) {
    String url =
        UriComponentsBuilder.fromUriString(baseUrl())
            .pathSegment("raw-divisions", id.toString())
            .build()
  ...
  public ScraperStatusView updateScraperStatus(String name, boolean enabled) {
    ...
    ScraperStatusInternalResponse body =
        internalApiClient.put(url, null, ScraperStatusInternalResponse.class).getBody();
    return body == null ? null : contractMapper.toResponse(body);
  }
  ...
  public List<ScraperStatusView> listScraperStatuses() {
    ...
    ScraperStatusInternalResponse[] body =
        internalApiClient.get(url, ScraperStatusInternalResponse[].class).getBody();
    return body == null
        ? Collections.emptyList()
        : Arrays.stream(body).map(contractMapper::toResponse).toList();
  }

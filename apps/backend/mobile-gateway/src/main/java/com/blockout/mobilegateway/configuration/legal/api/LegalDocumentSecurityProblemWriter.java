...
public class LegalDocumentSecurityProblemWriter implements AuthenticationEntryPoint, AccessDeniedHandler {
    ...
    private static final String V2_PREFIX = "/api/v2/mobile/secure/config/legal/";
    ...
    public LegalDocumentSecurityProblemWriter(ObjectMapper objectMapper, LegalDocumentProblemFactory problems) {
    ...
    private void write(
        ...
        response.setHeader(LegalDocumentProblemFactory.REQUEST_ID_HEADER, requestId);

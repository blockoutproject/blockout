...
/** Owns the pool index request, exact filters, and retained source projection. */
@Component
class ElasticsearchPoolSearchRequestFactory {
    ...
    SearchRequest create(FilteredSearchQuery query) {
        ...
        return SearchRequest.of(search -> search.index("pools")

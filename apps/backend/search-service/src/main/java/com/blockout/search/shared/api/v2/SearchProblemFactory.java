...
/** Creates canonical search Problem Details with stable request identifiers. */
@Component
public class SearchProblemFactory {

    public static final String REQUEST_ID_HEADER = "X-Request-Id";
    public static final String REQUEST_ID_ATTRIBUTE = SearchProblemFactory.class.getName() + ".requestId";
    private static final int MAX_REQUEST_ID_LENGTH = 255;
    private static final Logger LOGGER = LoggerFactory.getLogger(SearchProblemFactory.class);

...
public class RabbitMQConfig {
  ...
  public Binding bindTeamDeactivationQueueTeams(
      TopicExchange entityLifecycleExchange, Queue teamDeactivationQueueTeams) {
  ...
  public Binding bindClubDeactivationQueueTeams(
      TopicExchange entityLifecycleExchange, Queue clubDeactivationQueueTeams) {
  ...
  public Binding bindUserFollowQueueTeams(
    ...
    return BindingBuilder.bind(userFollowQueueTeams).to(userFollowExchange).with("team.follow");
  }

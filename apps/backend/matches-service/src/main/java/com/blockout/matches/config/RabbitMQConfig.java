...
public class RabbitMQConfig {
  ...
  public static final String TEAM_BY_POOL_DEACTIVATION_QUEUE_MATCHES =
      "teambypool.deactivation.queue.matches";
  ...
  public Binding bindTeamDeactivationQueueMatches(
      TopicExchange entityLifecycleExchange, Queue teamDeactivationQueueMatches) {
  ...
  public Binding bindPoolDeactivationQueueMatches(
      TopicExchange entityLifecycleExchange, Queue poolDeactivationQueueMatches) {
  ...
  public Binding bindTeamByPoolDeactivationQueueMatches(
      TopicExchange entityLifecycleExchange, Queue teamByPoolDeactivationQueueMatches) {
  ...
  public Binding bindMatchFinishedQueue(
      TopicExchange entityLifecycleExchange, Queue matchFinishedQueue) {
  ...
  public Binding bindMatchLiveLinkCreatedQueue(
      TopicExchange entityLifecycleExchange, Queue matchLiveLinkCreatedQueue) {

...
@Component
public class MatchesProblemFactory {

    private static final int MAX_REQUEST_ID_LENGTH = 255;
    private static final Logger LOGGER = LoggerFactory.getLogger(MatchesProblemFactory.class);
    public static final String REQUEST_ID_HEADER = "X-Request-Id";
    public static final String REQUEST_ID_ATTRIBUTE = MatchesProblemFactory.class.getName() + ".requestId";
    ...
    public ResponseEntity<ProblemDetail> response(
        ...
        ProblemDetail problem = new ProblemDetail(status.getReasonPhrase(), status.value(), code)
                ...
                .requestId(requestId);
        LOGGER.info("Matches v2 problem", keyValue("problemCode", code), keyValue("status", status.value()),

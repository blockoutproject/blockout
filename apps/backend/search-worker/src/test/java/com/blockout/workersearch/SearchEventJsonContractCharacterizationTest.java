...
class SearchEventJsonContractCharacterizationTest {
    ...
    @Test
    void readsTheCompleteTeamInternalResponseWithoutChangingTheSearchProjection() throws Exception {
        ObjectMapper objectMapper = new ObjectMapper().findAndRegisterModules();

        TeamDTO team = objectMapper.readValue("""
    ...
    @Test
    void readsTheCompletePoolInternalResponseWithoutChangingTheSearchProjection() throws Exception {

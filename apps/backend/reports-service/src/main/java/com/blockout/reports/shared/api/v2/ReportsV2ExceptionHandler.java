...
import com.blockout.reports.report.api.v2.ReportV2Controller;
...
/** Translates canonical report failures without changing the isolated v1 error map. */
@Order(Ordered.HIGHEST_PRECEDENCE)
@RestControllerAdvice(assignableTypes = ReportV2Controller.class)
@RequiredArgsConstructor
public class ReportsV2ExceptionHandler {

    private final ReportsProblemFactory problems;

    /** Maps generated and explicit input validation failures. */
    @ExceptionHandler({
    ...
    /** Maps the configured multipart aggregate and file limits. */
    ...
    /** Maps method-security failures that reach controller advice. */
    ...
    /** Hides storage and provider implementation details from canonical callers. */

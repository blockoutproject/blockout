// FILE: src/components/appStatus/AppStatusLayout.tsx
...
const AppStatusLayout: React.FC<AppStatusLayoutProps> = ({footer, children}) => {
  ...
  return (
    ...
    >
      ...
      {/* Zone centrale (la card arrivera ici) */}

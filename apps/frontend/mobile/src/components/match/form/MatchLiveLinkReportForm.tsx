...
import { reportMobileMatchLiveLink } from '@/src/api/generated/mobile-gateway/endpoints/mobile-match-live-links/mobile-match-live-links';
import {
  ReportMobileMatchLiveLinkBody,
  ReportMobileMatchLiveLinkParams,
  ReportMobileMatchLiveLinkResponse,
  ...
  const formik = useFormik<FormValues>({
    ...
    onSubmit: async (values) => {
      try {
        ...
        const path = ReportMobileMatchLiveLinkParams.parse({ matchId });
        const response = await reportMobileMatchLiveLink(
          path.matchId,
          ReportMobileMatchLiveLinkBody.parse({
            reason: values.reason.trim(),
          }),
        );
        ReportMobileMatchLiveLinkResponse.parse(response);

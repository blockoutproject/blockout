...
import { upsertMobileMatchLiveLink } from '@/src/api/generated/mobile-gateway/endpoints/mobile-match-live-links/mobile-match-live-links';
import {
  UpsertMobileMatchLiveLinkBody,
  UpsertMobileMatchLiveLinkParams,
  UpsertMobileMatchLiveLinkResponse,
  ...
  const formik = useFormik<FormValues>({
    ...
    onSubmit: async (values) => {
      ...
      try {
        ...
        const path = UpsertMobileMatchLiveLinkParams.parse({ matchId });
        const response = await upsertMobileMatchLiveLink(
          path.matchId,
          UpsertMobileMatchLiveLinkBody.parse({ url: trimmed }),
        );
        UpsertMobileMatchLiveLinkResponse.parse(response);

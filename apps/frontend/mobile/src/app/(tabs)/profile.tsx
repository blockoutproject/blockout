...
import { deleteCurrentMobileUser } from '@/src/api/generated/mobile-gateway/endpoints/mobile-users/mobile-users';
import { DeleteCurrentMobileUserResponse } from '@/src/api/generated/mobile-gateway/schemas/mobile-users/mobile-users.zod';
        ...
        { text: 'Annuler', style: 'cancel' },
        {
          ...
          onPress: async () => {
            ...
            try {
              ...
              await signOutSSO();
              const response = await deleteCurrentMobileUser();
              DeleteCurrentMobileUserResponse.parse(response);
              resetOnboarding();
              await Haptics.notificationAsync(

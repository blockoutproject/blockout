...
const RawDivisionMappingScreen: React.FC = () => {
  ...
  const [editing, setEditing] = useState<RawDivisionMappingResponse | null>(null);
  ...
  if (isLoading || !data) {
    return (
      <View style={[styles.center, {backgroundColor: theme.background}]} testID="raw-division-mapping-loading">

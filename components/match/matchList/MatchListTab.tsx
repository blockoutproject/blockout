...
import { PoolMatchesDTO, Match, MatchStatus } from "@/types/Match";
import { Pool } from "@/types/Pool";
import { Filter } from "@/types/Filter";
import MatchCard from "./components/MatchCard";
import FastImage from "react-native-fast-image";
import { formatDateFrenchLocale } from "@/utils/utils";
...
const MatchListTab: React.FC<MatchListTabProps> = ({
    ...
    const handleCardPress = useCallback((matchId: number) => {
    ...
    const renderItem = ({ item, index }: { item: PoolMatchesDTO, index: number }) => {
        return (
            <PoolItem
                ...
                mainLeagueColors={mainLeagueColors}
                secondLeagueColors={secondLeagueColors}
            />
        );
    };

...
class CreatePoolInternalRequest(BaseModel):
    """
    Pool creation input containing only caller-owned identity, display, and classification fields. Server identity, follower projection, lifecycle, and audit timestamps are not client-controlled.
    """ # noqa: E501
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreatePoolInternalRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreatePoolInternalRequest from a dict"""
        if obj is None:
            return None

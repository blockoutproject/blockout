...
class UpdatePoolInternalRequest(BaseModel):
    """
    Partial pool update. Omitted and explicit-null fields preserve stored values. Active true explicitly requests reactivation; active false explicitly requests deactivation. Application mapping separates lifecycle intent from identity, display, and classification changes.
    """ # noqa: E501
    pool_code: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, alias="poolCode")
    ...
    league_name: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, alias="leagueName")
    ...
    __properties: ClassVar[List[str]] = ["poolCode", "leagueCode", "season", "leagueName", "rawName", "name", "shortName", "divisionId", "format", "gender", "active"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdatePoolInternalRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdatePoolInternalRequest from a dict"""
        if obj is None:
            return None

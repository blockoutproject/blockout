...
class CreateRawDivisionMappingInternalRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["rawDivisionName", "divisionId", "format", "gender", "leagueCode", "season"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateRawDivisionMappingInternalRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateRawDivisionMappingInternalRequest from a dict"""
        if obj is None:
            return None

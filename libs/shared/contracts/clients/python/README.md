...
authoritative inputs are the committed v2 OpenAPI bundles for config, clubs, teams, pools, competition, and matches.
...
Everything under `src/**` is generated by OpenAPI Generator 7.23.0 through the pinned workspace CLI. Do not edit those
files. Run `npm exec nx run @blockout/contracts:generate-python-clients` from the workspace root instead.

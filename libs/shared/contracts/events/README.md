...
club channel from the clubs-service deployable and owns its producer operation. MRG-441 and MRG-442 do the same for
the team and pool channels from their owning deployables. No owner-fact consumer, queue, binding, or broker resource is
active; MRG-429 owns the future search-worker consumer operations.

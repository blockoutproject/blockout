...
## Active MRG-350 Boundary

MRG-350 defines only the six club, team, and pool lifecycle event families: upsert and deactivation for each owner.
It records match and follow routes as deferred, and explicitly records no v2 activation for `EV-TPD`, Q-11 through
Q-13, or Q-16 through Q-17. The contracts describe messages and channels; they do not declare broker resources or
activate publishers, listeners, queues, exchanges, outboxes, deduplication, shadow consumption, or production traffic.

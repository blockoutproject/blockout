...
| 25 — Rankings                        | FR-019, FR-020                                                              | Official positions/ties/statistics, unusable snapshots, collection/source freshness |
| 26 — Feeds                           | FR-011 through FR-014, FR-030 through FR-032                                | Device-local instants, source-date exception, bounded continuation and refresh      |
...
| 30 — Profile recreation              | FR-002, FR-004, FR-005, FR-009, FR-010                                      | S01/S12; simultaneous login, initiating profile, independent billing identity       |
| 31 — RevenueCat                      | FR-006 through FR-010, FR-047                                               | S12/S13; purchases/restores, expiry/outage, switching, paid conflicts and aliases   |

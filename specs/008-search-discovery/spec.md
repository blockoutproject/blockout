...
2. **A06** — **Étant donné** des équipes et poules possédant les champs connus prévus par F04, **lorsque** chaque champ est recherché séparément, **alors** nom complet ou court, club, ville du club et division retrouvent les équipes concernées ; nom complet ou court, division et ligue retrouvent les poules concernées. Nom et ville retrouvent les clubs. Après correction de la ville selon F02, recherche et informations de distinction utilisent la ville effective ; une absence volontaire retire ce champ sans masquer le club ou ses équipes. La ville brute remplacée ne reste pas un critère de correspondance par localité. Un retour à la source suit la valeur actuelle autorisée et la propagation F13. (FR-006, FR-021, FR-026)
...
- **FR-006** : La recherche DOIT porter sur le nom et la ville des clubs ; les noms complet et court, le club, la ville du club et la division des équipes ; les noms complet et court, la division et la ligue des poules. Les champs absents ne sont pas inventés. La ville utilisée pour rechercher et distinguer un club ou ses équipes DOIT être la valeur effective autorisée selon F02 FR-049, après correction, absence volontaire ou retour à la source. Une ville source remplacée, volontairement absente ou restreinte NE DOIT PAS servir de repli ; les règles propres aux noms et alias restent distinctes.

...
| [F10](../012-reports-feature-suggestions/spec.md) / F12                                   | Signalement contextualisé et permissions d’administration, sans nouvel éditeur ni autorisation implicite.                                                                                                                                                       |
...
| F14 / R01 / R02                                                                           | Reprise des données, cohérence globale et conception visuelle. R02 couvre exemples/recherche, filtres actifs ou indisponibles, homonymes, chargements successifs, liste partielle et reprise accessible. Aucun écran Figma n’est déclaré validé par cette spec. |

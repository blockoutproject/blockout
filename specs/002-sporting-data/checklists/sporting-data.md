...
- [ ] CHK027 Les permissions administratives et les résultats de refus sont-ils définis y compris correction, absence volontaire et retour à la source des coordonnées de club, sans attribuer tous les privilèges aux modérateurs ni inventer un éditeur de matchs ? [Complétude, Spécification §FR-047–FR-048]
- [ ] CHK028 Les trois modes indépendants des coordonnées (source, correction durable, absence volontaire), les retours à la valeur automatique actuelle autorisée, les restrictions F11, les refus/reprises et la localisation effective sont-ils définis, y compris changement de rue seul, évolution source masquée par une correction et réponse de géocodage périmée ? [Couverture, Spécification §FR-049–FR-053, §A05, §A36–A38]

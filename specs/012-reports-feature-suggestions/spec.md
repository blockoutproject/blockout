...
1. **A01** — **Étant donné** un invité ou une personne connectée, **lorsqu’**elle accède à l’assistance, **alors** le même formulaire permet un problème ou une suggestion ; un échec de connexion ou de chargement ne supprime pas le point d’entrée pertinent. Maintenance et mise à jour obligatoire F12 conservent cet accès à l’assistance. (FR-001, FR-002)
...
- **FR-001** : L’assistance DOIT être accessible aux invités et utilisateurs connectés, avant connexion et après échec d’authentification ou de chargement ; le point d’entrée pertinent ne dépend pas du succès du parcours problématique. Les restrictions globales de maintenance et de version F12 conservent cet accès ; elles ne dispensent pas des exigences de réception complète.
...
| [F13](../003-shared-quality/spec.md), [F12](../013-administration-app-configuration/spec.md) / [#269](https://github.com/blockoutproject/blockout/issues/269) | Qualité, sécurité et diagnostics ; attribution des permissions selon la finalité.                                                                          |

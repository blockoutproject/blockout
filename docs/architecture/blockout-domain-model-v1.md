...
- Source packs supply classification defaults with complete pool overrides. A professional phase may have authoritative LNV evidence without an FFVB counterpart.
...
- Sporting state conservation, source presence, collection eligibility and consultation visibility are distinct. Hidden identities and relationships persist; clubs remain consultable without visible teams.

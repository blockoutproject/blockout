...
| Projection versions      | [`migration/mrg-437-projection-version-authority.md`](migration/mrg-437-projection-version-authority.md)                     | Owner revisions, projection facts, and vector ordering      |
| Owner projection facts   | [`migration/mrg-438-owner-projection-fact-contracts.md`](migration/mrg-438-owner-projection-fact-contracts.md)               | Model-only owner facts and generated event records          |
| Division revisions       | [`migration/mrg-439-config-division-revision.md`](migration/mrg-439-config-division-revision.md)                             | Persisted division version and internal worker snapshots    |
| Club revisions           | [`migration/mrg-440-club-revision-event.md`](migration/mrg-440-club-revision-event.md)                                       | Persisted club version and transactional owner event        |
| Team revisions           | [`migration/mrg-441-team-revision-event.md`](migration/mrg-441-team-revision-event.md)                                       | Persisted team version and transactional owner event        |
| Pre-cutover cleanliness  | [`migration/mrg-443-pre-cutover-cleanliness.md`](migration/mrg-443-pre-cutover-cleanliness.md)                               | Canonical core, compatibility shell, and scraper gates      |
...
| Generated backend enums  | [`migration/mrg-432-generated-backend-enums.md`](migration/mrg-432-generated-backend-enums.md)                               | Shared enum sources, generation, parity, and guard          |
| Python uv workspace      | [`migration/mrg-433-nx-python-uv-workspace.md`](migration/mrg-433-nx-python-uv-workspace.md)                                 | Nx plugin, uv ownership, parity, rollback, and guard        |
...
| Pool revisions           | [`migration/mrg-442-pool-revision-event.md`](migration/mrg-442-pool-revision-event.md)                                       | Owner revision and transactional projection event           |

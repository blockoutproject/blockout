...
exercise production data as part of an automated test. Client IDs, issuer URLs, and audiences are public OAuth metadata;
client secrets and user credentials remain only in ignored local files or the provider.

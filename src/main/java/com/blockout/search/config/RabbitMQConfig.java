...
public class RabbitMQConfig {
    ...
    public static final String CLUB_LIFECYCLE_QUEUE_SEARCH = "club.lifecycle.queue.search";
    public static final String TEAM_LIFECYCLE_QUEUE_SEARCH = "team.lifecycle.queue.search";
    public static final String POOL_LIFECYCLE_QUEUE_SEARCH = "pool.lifecycle.queue.search";

    public static final String CLUB_DLQ = "club.lifecycle.queue.search.dlq";
    public static final String TEAM_DLQ = "team.lifecycle.queue.search.dlq";
    public static final String POOL_DLQ = "pool.lifecycle.queue.search.dlq";

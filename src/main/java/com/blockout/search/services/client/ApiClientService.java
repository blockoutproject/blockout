...
public class ApiClientService {
    ...
    public <T> ResponseEntity<T> get(String url, Class<T> responseType) {
        ...
        try {
            ResponseEntity<T> response = authenticatedRestTemplate.exchange(url, HttpMethod.GET, null, responseType);
    ...
    public <T, B> ResponseEntity<T> post(String url, B body, Class<T> responseType) {
        ...
        try {
            ...
            ResponseEntity<T> response = authenticatedRestTemplate.exchange(url, HttpMethod.POST, request, responseType);

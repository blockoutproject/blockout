...
import { MatchLiveLinkFormExternalState } from "./MatchLiveLinkForm";
import { getLiveLinkErrorMessage } from "./MatchLiveLinkForm";
...
const MatchLiveLinkDeleteForm: React.FC<MatchLiveLinkDeleteFormProps> = ({
    ...
    const handleDelete = useCallback(async () => {
        try {
            ...
            await mobile.deleteMatchLiveLink(matchId);
                ...
                <FormCard title="Supprimer le lien du live">
                    <View style={styles.warningRow}>
                        ...
                        <View style={styles.warningTextBlock}>
                            ...
                            >
                                Le lien ne sera plus visible sur la fiche du match.
                                Tu pourras toujours en ajouter un nouveau plus tard.
                            </Text>
                        </View>
                    </View>

                    {liveUrl && (
                        <View style={[styles.urlBlock, { borderColor: theme.borderSecondary }]}>
                            <Text
                                style={[
                                    styles.urlLabel,
                                    { color: theme.textInactive },

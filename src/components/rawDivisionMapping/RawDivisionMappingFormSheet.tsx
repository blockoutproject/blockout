...
import RawDivisionMappingForm, { RawDivisionMappingFormExternalState } from "@/src/components/rawDivisionMapping/RawDivisionMappingForm";
...
const RawDivisionMappingFormSheet = forwardRef<BottomSheetModal, RawDivisionMappingFormSheetProps>(
    ({ mapping, onSuccess, snapPoint = "90%", footerLabel = "Enregistrer" }, ref) => {
        ...
        const [footerState, setFooterState] = useState<RawDivisionMappingFormExternalState>({ loading: false, canSubmit: true });

...
import { View, Text, Pressable, StyleSheet, StyleSheet as RNStyleSheet } from "react-native";
...
const RankingRow = ({ item, index, theme, highlightTeams, gradient, onPress }: any) => {
    const rank = index + 1;
    const hl = highlightTeams?.find((h: any) => h.teamId === item.id);

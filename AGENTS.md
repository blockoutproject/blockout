...
- Application-owned JSON fields use camelCase. Do not rename database columns, environment variables, headers, URLs, or provider-owned payloads to enforce that rule.
